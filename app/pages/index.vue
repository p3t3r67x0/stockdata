...
<div>
  <table v-if="'averages' in avgData && avgData.averages.length > 0" class="table-fixed w-full mb-6">
    ...
    <tr class="bg-gray-100 text-lg">
      <td class="font-bold p-3">High 1 day</td>
      <td class="p-3">{{ avgData['averages'][0]['high_one_day']['end'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['high_one_day']['start'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['high_one_day']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-300 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['high_ten_days']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-100 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['high_thirty_days']['value'] }} USD</td>
    </tr>
  </table>
  <table v-if="'averages' in avgData && avgData.averages.length > 0" class="table-fixed w-full mb-6">
    <tr class="bg-teal-900 text-white text-md">
    ...
    <tr class="bg-gray-100 text-lg">
      <td class="font-bold p-3">Low 1 day</td>
      <td class="p-3">{{ avgData['averages'][0]['low_one_day']['end'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['low_one_day']['start'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['low_one_day']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-300 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['low_ten_days']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-100 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['low_thirty_days']['value'] }} USD</td>
    </tr>
  </table>
  <table v-if="'averages' in avgData && avgData.averages.length > 0" class="table-fixed w-full mb-6">
    <tr class="bg-teal-900 text-white text-md">
    ...
    <tr class="bg-gray-300 text-lg">
      <td class="font-bold p-3">Open 1 day</td>
      <td class="p-3">{{ avgData['averages'][0]['open_one_day']['end'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['open_one_day']['start'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['open_one_day']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-100 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['open_ten_days']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-300 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['open_thirty_days']['value'] }} USD</td>
    </tr>
  </table>
  <table v-if="'averages' in avgData && avgData.averages.length > 0" class="table-fixed w-full mb-6">
    <tr class="bg-teal-900 text-white text-md">
    ...
    <tr class="bg-gray-100 text-lg">
      <td class="font-bold p-3">Close 1 day</td>
      <td class="p-3">{{ avgData['averages'][0]['close_one_day']['end'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['close_one_day']['start'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['close_one_day']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-300 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['close_ten_days']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-100 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['close_thirty_days']['value'] }} USD</td>
    </tr>
  </table>
  <table v-if="'averages' in avgData && avgData.averages.length > 0" class="table-fixed w-full mb-6">
    <tr class="bg-teal-900 text-white text-md">
    ...
    <tr class="bg-gray-300 text-lg">
      <td class="font-bold p-3">Adjust close 1 day</td>
      <td class="p-3">{{ avgData['averages'][0]['adjust_one_day']['end'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['adjust_one_day']['start'] }}</td>
      <td class="p-3">{{ avgData['averages'][0]['adjust_one_day']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-100 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['adjust_ten_days']['value'] }} USD</td>
    </tr>
    <tr class="bg-gray-300 text-lg">
      ...
      <td class="p-3">{{ avgData['averages'][0]['adjust_thirty_days']['value'] }} USD</td>
    </tr>
  </table>
...
export default {
  ...
  created() {
    ...
    this.$axios.$get('http://localhost:8000/average/fb').then(res => {
      this.avgData = res
    })
  }
}
